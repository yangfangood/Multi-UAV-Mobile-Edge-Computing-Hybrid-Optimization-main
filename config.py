...
ALPHA_1 = 1.5  # weightage for latency (negative term, higher = stronger penalty for latency) 延迟权重（越大越惩罚延迟）
...
REWARD_SCALING_FACTOR: float = 0.001

# 根据训练前期经验设定合理上限（可调） 归一化的基准值
MAX_LATENCY = 5e9  # 最大总延迟（秒）
MAX_ENERGY = 1e8  # 最大总能耗（焦耳）
